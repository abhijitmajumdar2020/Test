...
const params = {
    ...
    sections:
    {
        ...
        DEFECT: {
            ...
            data: 'DefectData',
            calculatedcols: [
                function (rowNo, row) { return (rowNo == 0 ? 'Age' : dateDiff(row[5], row[6] == '' ? params.reportdate : row[6])) },
                function (rowNo, row) { return (rowNo == 0 ? 'Age Bin' : getAgeBucket(row[5], row[6])) },
            ],
            ...
            charts: {
                ...
                bars: {
                    ...
                    include: function (row) { return (row[6] == '') },
                    filters: [
                        { col: 'Tech', values: ['MF', 'WEB'] },
                        { col: 'Area', values: ['AML', 'LOAN', 'SAVE'] },
...
function ps(section) {
    return params.sections[section];
}